---
title: Prfaq Package Synthesis
description: Human-facing operating guide for ai-sdlc-prfaq-package-synthesis, including inputs, authority, artifacts, modes, helpers, gates, recovery, and handoff.
---
...
```text
Use ai-sdlc-prfaq-package-synthesis for <target>.
...
produce or report PRFAQ, FAQ package, and BRD-style requirements summary, preserve human approval boundaries,
...
| --- | --- | --- | --- |
| [`prfaq_outline.py`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-prfaq-package-synthesis/scripts/prfaq_outline.py) | Compress discovery input into PRFAQ package readiness signals. | `python3 skills/ai-sdlc-prfaq-package-synthesis/scripts/prfaq_outline.py --feature <feature-name> --quick-flow <input.md>...` | Read-only/reporting by default; inspect `--help` and the owning skill before direct use. |
...
A successful result produces PRFAQ, FAQ package, and BRD-style requirements summary and satisfies every output rule and blocker check below.
...
This page is generated from [`skills/ai-sdlc-prfaq-package-synthesis/SKILL.md`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-prfaq-package-synthesis/SKILL.md). Edit the source contract, rerun the catalog generator, and review both changes together; never hand-edit this page.
