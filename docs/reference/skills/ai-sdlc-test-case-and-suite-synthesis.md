---
title: Test Case And Suite Synthesis
description: Human-facing operating guide for ai-sdlc-test-case-and-suite-synthesis, including inputs, authority, artifacts, modes, helpers, gates, recovery, and handoff.
---
...
| --- | --- | --- | --- | --- |
| Detailed test design | QA | BA, Dev, PM | `core` | Executable test cases plus smoke, regression, and UAT suites |
...
```text
Use ai-sdlc-test-case-and-suite-synthesis for <target>.
...
produce or report Executable test cases plus smoke, regression, and UAT suites, preserve human approval boundaries,
...
| --- | --- | --- | --- |
| [`suite_outline.py`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-test-case-and-suite-synthesis/scripts/suite_outline.py) | Compress test cases into suite synthesis signals. | `python3 skills/ai-sdlc-test-case-and-suite-synthesis/scripts/suite_outline.py --feature <feature-name> --quick-flow <input.md>...` | Read-only/reporting by default; inspect `--help` and the owning skill before direct use. |
...
A successful result produces Executable test cases plus smoke, regression, and UAT suites and satisfies every output rule and blocker check below.
...
This page is generated from [`skills/ai-sdlc-test-case-and-suite-synthesis/SKILL.md`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-test-case-and-suite-synthesis/SKILL.md). Edit the source contract, rerun the catalog generator, and review both changes together; never hand-edit this page.
