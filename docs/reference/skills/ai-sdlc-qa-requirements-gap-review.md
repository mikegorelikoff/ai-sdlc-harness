...
description: Human-facing operating guide for ai-sdlc-qa-requirements-gap-review, including inputs, authority, artifacts, modes, helpers, gates, recovery, and handoff.
---
...
| --- | --- | --- | --- | --- |
| Pre-QA requirements review | QA | BA, PM, Dev | `core` | QA-blocking gaps, missing business rules, ambiguity, and testability risks |
...
```text
Use ai-sdlc-qa-requirements-gap-review for <target>.
...
produce or report QA-blocking gaps, missing business rules, ambiguity, and testability risks, preserve human approval boundaries,
...
| --- | --- | --- | --- |
| [`qa_gap_scan.py`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-qa-requirements-gap-review/scripts/qa_gap_scan.py) | Compress requirements into QA-blocking gap signals. | `python3 skills/ai-sdlc-qa-requirements-gap-review/scripts/qa_gap_scan.py --feature <feature-name> --quick-flow <input.md>...` | Read-only/reporting by default; inspect `--help` and the owning skill before direct use. |
...
A successful result produces QA-blocking gaps, missing business rules, ambiguity, and testability risks and satisfies every output rule and blocker check below.
...
This page is generated from [`skills/ai-sdlc-qa-requirements-gap-review/SKILL.md`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-qa-requirements-gap-review/SKILL.md). Edit the source contract, rerun the catalog generator, and review both changes together; never hand-edit this page.
