---
title: Delivery Spec Synthesis
description: Human-facing operating guide for ai-sdlc-delivery-spec-synthesis, including inputs, authority, artifacts, modes, helpers, gates, recovery, and handoff.
---
...
| --- | --- | --- | --- | --- |
| Delivery specification | BA | Dev, QA, PM, Delivery | `core` | Structured delivery specification for engineering and cross-functional planning |
...
```text
Use ai-sdlc-delivery-spec-synthesis for <target>.
...
produce or report Structured delivery specification for engineering and cross-functional planning, preserve human approval boundaries,
...
| --- | --- | --- | --- |
| [`delivery_spec_scaffold.py`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-delivery-spec-synthesis/scripts/delivery_spec_scaffold.py) | Compress refined artifacts into delivery-spec synthesis signals. | `python3 skills/ai-sdlc-delivery-spec-synthesis/scripts/delivery_spec_scaffold.py --feature <feature-name> --quick-flow <input.md>...` | Read-only/reporting by default; inspect `--help` and the owning skill before direct use. |
...
A successful result produces Structured delivery specification for engineering and cross-functional planning and satisfies every output rule and blocker check below.
...
This page is generated from [`skills/ai-sdlc-delivery-spec-synthesis/SKILL.md`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-delivery-spec-synthesis/SKILL.md). Edit the source contract, rerun the catalog generator, and review both changes together; never hand-edit this page.
