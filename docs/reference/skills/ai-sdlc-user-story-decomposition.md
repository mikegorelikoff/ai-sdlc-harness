...
description: Human-facing operating guide for ai-sdlc-user-story-decomposition, including inputs, authority, artifacts, modes, helpers, gates, recovery, and handoff.
---
...
| --- | --- | --- | --- | --- |
| Story decomposition | BA | Product Owner, PM, QA, Dev | `core` | Epics, user stories, acceptance criteria, scenario coverage, and priority signals |
...
```text
Use ai-sdlc-user-story-decomposition for <target>.
...
produce or report Epics, user stories, acceptance criteria, scenario coverage, and priority signals, preserve human approval boundaries,
...
A successful result produces Epics, user stories, acceptance criteria, scenario coverage, and priority signals and satisfies every output rule and blocker check below.
...
This page is generated from [`skills/ai-sdlc-user-story-decomposition/SKILL.md`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-user-story-decomposition/SKILL.md). Edit the source contract, rerun the catalog generator, and review both changes together; never hand-edit this page.
