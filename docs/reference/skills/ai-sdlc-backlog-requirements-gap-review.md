...
| --- | --- | --- | --- | --- |
| Pre-backlog planning review | BA | PM, Delivery, QA | `core` | Backlog-blocking gaps, assumptions, open questions, and readiness decision |
...
This page is generated from [`skills/ai-sdlc-backlog-requirements-gap-review/SKILL.md`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-backlog-requirements-gap-review/SKILL.md). Edit the source contract, rerun the catalog generator, and review both changes together; never hand-edit this page.
