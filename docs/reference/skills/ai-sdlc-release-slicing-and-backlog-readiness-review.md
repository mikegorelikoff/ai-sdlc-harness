---
title: Release Slicing And Backlog Readiness Review
description: Human-facing operating guide for ai-sdlc-release-slicing-and-backlog-readiness-review, including inputs, authority, artifacts, modes, helpers, gates, recovery, and handoff.
---
...
| --- | --- | --- | --- | --- |
| Release planning / backlog readiness | PM | Product Owner, Delivery, BA, QA, Dev Lead | `core` | MVP/release slices, sequencing, readiness score, and planning risks |
...
```text
Use ai-sdlc-release-slicing-and-backlog-readiness-review for <target>.
...
produce or report MVP/release slices, sequencing, readiness score, and planning risks, preserve human approval boundaries,
...
| --- | --- | --- | --- |
| [`release_slice_plan.py`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-release-slicing-and-backlog-readiness-review/scripts/release_slice_plan.py) | Compress backlog artifacts into release-slicing readiness signals. | `python3 skills/ai-sdlc-release-slicing-and-backlog-readiness-review/scripts/release_slice_plan.py --feature <feature-name> --quick-flow <input.md>...` | Read-only/reporting by default; inspect `--help` and the owning skill before direct use. |
...
A successful result produces MVP/release slices, sequencing, readiness score, and planning risks and satisfies every output rule and blocker check below.
...
This page is generated from [`skills/ai-sdlc-release-slicing-and-backlog-readiness-review/SKILL.md`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-release-slicing-and-backlog-readiness-review/SKILL.md). Edit the source contract, rerun the catalog generator, and review both changes together; never hand-edit this page.
