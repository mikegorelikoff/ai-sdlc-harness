...
- [x] T002. Build the beginner-first foundations and first-use path.
  ...
  Depends-On: T001
- [ ] T003. Publish runnable tutorials and the complete lifecycle flow library.
  ...
  Depends-On: T002
- [ ] T004. Generate complete human-facing skill and script documentation.
  Output: Enhanced deterministic catalog generator, 43/43 per-skill guides, complete in-scope script inventory, coverage manifest, required detail fields, navigation/discovery surfaces, parser/render/coverage tests, and one focused commit.
  Refs: AC-007, AC-008, AC-014, AC-015, AC-018
  Depends-On: T003
- [ ] T005. Publish adoption, governance, operations, and maintainer guidance.
  ...
  Depends-On: T004
- [ ] T006. Close independent persona review and release-quality validation.
...
## Testing
Each task includes focused source, link, navigation, and content checks for its pages. T004 adds inventory closure and generator unit tests. T006 runs every documentation, strict build, rendered target, shared skill, compatibility, SDD, prohibited-name, and Git audit gate. Any persona P0/P1 finding reopens the owning task content and must be corrected before T006 completes.

## Documentation
T002 establishes the learning vocabulary and first-use contract. T003 teaches journeys and exact lifecycle behavior. T004 ensures every executable capability is discoverable and complete. T005 supports team adoption, governance, recovery, and contribution. T006 reconciles all indexes, cross-links, claims, and reviewer feedback. Public `docs/` is canonical; root guides/concepts must not remain a contradictory onboarding dependency.
