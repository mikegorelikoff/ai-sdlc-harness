...
| DEC-004 | 2026-07-19 | accepted | Dev | Organize a roughly forty-page corpus by reader intent: tutorials, how-to guides, explanations, and references. | A mature documentation benchmark showed that intent-based grouping and comparable depth make complex workflow systems discoverable. | Six broad product pages; one page per skill; intent-based corpus with generated catalogs | `docs/_data/navigation.yml`, `docs/tutorials/`, `docs/how-to/`, `docs/explanation/`, `docs/reference/` | AC-003; AC-004; AC-005; TC-003; TC-004; TC-005 |
