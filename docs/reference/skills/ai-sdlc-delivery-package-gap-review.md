...
description: Human-facing operating guide for ai-sdlc-delivery-package-gap-review, including inputs, authority, artifacts, modes, helpers, gates, recovery, and handoff.
---
...
```text
Use ai-sdlc-delivery-package-gap-review for <target>.
...
produce or report Delivery gaps, contradictions, missing business rules, and handoff blockers, preserve human approval boundaries,
...
A successful result produces Delivery gaps, contradictions, missing business rules, and handoff blockers and satisfies every output rule and blocker check below.
...
This page is generated from [`skills/ai-sdlc-delivery-package-gap-review/SKILL.md`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-delivery-package-gap-review/SKILL.md). Edit the source contract, rerun the catalog generator, and review both changes together; never hand-edit this page.
