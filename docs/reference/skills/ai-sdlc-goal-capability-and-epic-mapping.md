---
title: Goal Capability And Epic Mapping
description: Human-facing operating guide for ai-sdlc-goal-capability-and-epic-mapping, including inputs, authority, artifacts, modes, helpers, gates, recovery, and handoff.
---
...
| --- | --- | --- | --- | --- |
| Planning architecture | PM | BA, Delivery | `core` | Goal-to-capability map and outcome-oriented epics |
...
```text
Use ai-sdlc-goal-capability-and-epic-mapping for <target>.
...
produce or report Goal-to-capability map and outcome-oriented epics, preserve human approval boundaries,
...
| --- | --- | --- | --- |
| [`goal_capability_map.py`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-goal-capability-and-epic-mapping/scripts/goal_capability_map.py) | Compress planning artifacts into goal-capability-epic mapping signals. | `python3 skills/ai-sdlc-goal-capability-and-epic-mapping/scripts/goal_capability_map.py --feature <feature-name> --quick-flow <input.md>...` | Read-only/reporting by default; inspect `--help` and the owning skill before direct use. |
...
A successful result produces Goal-to-capability map and outcome-oriented epics and satisfies every output rule and blocker check below.
...
This page is generated from [`skills/ai-sdlc-goal-capability-and-epic-mapping/SKILL.md`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-goal-capability-and-epic-mapping/SKILL.md). Edit the source contract, rerun the catalog generator, and review both changes together; never hand-edit this page.
