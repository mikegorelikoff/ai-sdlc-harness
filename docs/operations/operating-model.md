...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Problem/value accepted | Product owner | PM | Research, BA, representative users | Delivery and engineering leads | Gather and synthesize evidence. | Invent customers or accept value. | Discovery, sources, assumptions, decision. | Product leadership. |
| Requirements ready | Product/BA owner | BA | PM, QA, architecture, dev | Delivery and affected implementers | Derive actors, rules, scenarios, gaps. | Resolve material ambiguity silently. | Requirements, decisions, gap/readiness result. | Product owner. |
| UX/architecture accepted | Engineering/architecture owner | Architect or UX owner | Security, dev, QA, product | Delivery and affected teams | Propose options and trace constraints. | Select material trade-offs without review. | Design, alternatives, risks, decision. | Engineering lead. |
...
| Release slice approved | Product/delivery owner | PM or delivery lead | Engineering, QA, security | Affected teams and stakeholders | Analyze dependency and readiness. | Change priority or scope approval. | Backlog, dependencies, release decision. | Product/delivery leadership. |
...
| Security/privacy accepted | Security/privacy owner | Security reviewer | Engineering, legal/compliance, data owner | Product, delivery, and incident owner | Test, enumerate abuse cases, report evidence. | Declare legal compliance or accept residual risk. | Threats, findings, remediation, exceptions. | Security leadership. |
| Validation complete | Engineering/QA owner | Developer or QA executor | QA, CI owners, security as required | Change and delivery owners | Run focused deterministic checks and report exact results. | Claim skipped or stale evidence passed. | Commands, outputs, revision, environment, gaps. | Change owner. |
