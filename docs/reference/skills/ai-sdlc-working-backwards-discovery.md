...
description: Human-facing operating guide for ai-sdlc-working-backwards-discovery, including inputs, authority, artifacts, modes, helpers, gates, recovery, and handoff.
---
...
```text
Use ai-sdlc-working-backwards-discovery for <target>.
...
A successful result produces Structured discovery notes, clarified assumptions, open questions, and PRFAQ-ready facts and satisfies every output rule and blocker check below.
