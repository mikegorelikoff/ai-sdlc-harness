---
title: Qa Traceability And Readiness Review
description: Human-facing operating guide for ai-sdlc-qa-traceability-and-readiness-review, including inputs, authority, artifacts, modes, helpers, gates, recovery, and handoff.
---
...
```text
Use ai-sdlc-qa-traceability-and-readiness-review for <target>.
...
produce or report Requirements-to-test traceability matrix, coverage gaps, blockers, and readiness score, preserve human approval boundaries,
...
| --- | --- | --- | --- |
| [`traceability_matrix.py`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-qa-traceability-and-readiness-review/scripts/traceability_matrix.py) | Compress requirements and tests into traceability readiness signals. | `python3 skills/ai-sdlc-qa-traceability-and-readiness-review/scripts/traceability_matrix.py --feature <feature-name> --quick-flow <input.md>...` | Read-only/reporting by default; inspect `--help` and the owning skill before direct use. |
...
A successful result produces Requirements-to-test traceability matrix, coverage gaps, blockers, and readiness score and satisfies every output rule and blocker check below.
...
This page is generated from [`skills/ai-sdlc-qa-traceability-and-readiness-review/SKILL.md`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-qa-traceability-and-readiness-review/SKILL.md). Edit the source contract, rerun the catalog generator, and review both changes together; never hand-edit this page.
