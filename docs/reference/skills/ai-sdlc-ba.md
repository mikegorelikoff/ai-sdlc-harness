---
title: Ba
description: Human-facing operating guide for ai-sdlc-ba, including inputs, authority, artifacts, modes, helpers, gates, recovery, and handoff.
---
...
produce or report Business context, rules, assumptions, out-of-scope items, acceptance criteria, and open questions, preserve human approval boundaries,
...
| --- | --- | --- | --- |
| [`ba_context_scaffold.py`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-ba/scripts/ba_context_scaffold.py) | Compress source notes into BA context signals. | `python3 skills/ai-sdlc-ba/scripts/ba_context_scaffold.py --feature <feature-name> --quick-flow <input.md>...` | Read-only/reporting by default; inspect `--help` and the owning skill before direct use. |
...
This page is generated from [`skills/ai-sdlc-ba/SKILL.md`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-ba/SKILL.md). Edit the source contract, rerun the catalog generator, and review both changes together; never hand-edit this page.
