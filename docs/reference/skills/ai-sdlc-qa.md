---
title: Qa
description: Human-facing operating guide for ai-sdlc-qa, including inputs, authority, artifacts, modes, helpers, gates, recovery, and handoff.
---
...
produce or report QA acceptance plan, regression targets, manual checks, validation evidence, and residual risks, preserve human approval boundaries,
...
This page is generated from [`skills/ai-sdlc-qa/SKILL.md`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-qa/SKILL.md). Edit the source contract, rerun the catalog generator, and review both changes together; never hand-edit this page.
