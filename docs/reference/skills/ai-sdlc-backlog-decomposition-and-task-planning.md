...
| --- | --- | --- | --- | --- |
| Backlog decomposition | PM | BA, QA, Dev Lead, Delivery | `core` | Features, user stories, acceptance summaries, and cross-functional delivery tasks |
...
- **Supporting:** BA, QA, Dev Lead, Delivery.
