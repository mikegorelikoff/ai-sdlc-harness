---
title: Code Review
description: Human-facing operating guide for ai-sdlc-code-review, including inputs, authority, artifacts, modes, helpers, gates, recovery, and handoff.
---
...
```text
Use ai-sdlc-code-review for <target>.
...
produce or report Findings-first review with severity, path, impact, fix, validation gaps, and residual risk, preserve human approval boundaries,
...
This page is generated from [`skills/ai-sdlc-code-review/SKILL.md`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-code-review/SKILL.md). Edit the source contract, rerun the catalog generator, and review both changes together; never hand-edit this page.
