...
- [ ] T002: - [ ] T002. Implement the context-aware AI SDLC navigator.; refs: AC-001; output: Navigator skill, deterministic router CLI, Markdown and TOON outputs, tests, and docs.
