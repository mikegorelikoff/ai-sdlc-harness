---
title: Explanation
description: Understand why the harness is structured around evidence, adaptive rigor, and durable handoffs.
---
...
- [**Adaptive rigor**](adaptive-rigor.md) — why controls scale with risk.
- [**Artifact authority**](artifact-authority.md) — which evidence is authoritative and where it lives.
- [**Feature state machine**](state-machine.md) — how lifecycle stages remain explicit.
- [**Traceability**](traceability.md) — how intent connects to tests and commits.
...
For step-by-step outcomes, use [How-to guides](../how-to/index.md). For exact paths, schemas, and commands, use [Reference](../reference/index.md).
