---
title: Branching
description: Human-facing operating guide for ai-sdlc-branching, including inputs, authority, artifacts, modes, helpers, gates, recovery, and handoff.
---
...
```text
Use ai-sdlc-branching for <target>.
...
produce or report Branching decision, branch name, base branch, dirty-tree assessment, and next handoff, preserve human approval boundaries,
...
| --- | --- | --- | --- |
| [`branch_plan.py`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-branching/scripts/branch_plan.py) | Compress spec/task context into branch alignment signals. | `python3 skills/ai-sdlc-branching/scripts/branch_plan.py --feature <feature-name> --quick-flow <input.md>...` | Read-only/reporting by default; inspect `--help` and the owning skill before direct use. |
...
This page is generated from [`skills/ai-sdlc-branching/SKILL.md`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-branching/SKILL.md). Edit the source contract, rerun the catalog generator, and review both changes together; never hand-edit this page.
