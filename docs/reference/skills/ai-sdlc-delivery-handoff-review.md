...
description: Human-facing operating guide for ai-sdlc-delivery-handoff-review, including inputs, authority, artifacts, modes, helpers, gates, recovery, and handoff.
---
...
```text
Use ai-sdlc-delivery-handoff-review for <target>.
...
produce or report Handoff readiness score, remaining blockers, contradictions, and execution risks, preserve human approval boundaries,
...
| --- | --- | --- | --- |
| [`handoff_readiness_score.py`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-delivery-handoff-review/scripts/handoff_readiness_score.py) | Compress delivery artifacts into handoff readiness signals. | `python3 skills/ai-sdlc-delivery-handoff-review/scripts/handoff_readiness_score.py --feature <feature-name> --quick-flow <input.md>...` | Read-only/reporting by default; inspect `--help` and the owning skill before direct use. |
...
A successful result produces Handoff readiness score, remaining blockers, contradictions, and execution risks and satisfies every output rule and blocker check below.
...
This page is generated from [`skills/ai-sdlc-delivery-handoff-review/SKILL.md`](https://github.com/mikegorelikoff/ai-sdlc-harness/blob/main/skills/ai-sdlc-delivery-handoff-review/SKILL.md). Edit the source contract, rerun the catalog generator, and review both changes together; never hand-edit this page.
